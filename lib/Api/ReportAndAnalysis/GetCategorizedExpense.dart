...
Future<Map<String, dynamic>> fetchCategorizedExpense(String bearerToken) async {
  const url = 'https://finace-management-api-typescript.onrender.com/api/v1/transactions/expense/categorize';
